...
public final class GridItemBinding implements ViewBinding {
  ...
  private GridItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView gridImage,
  ...
  public static GridItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.grid_image;
      ImageView gridImage = rootView.findViewById(id);
      if (gridImage == null) {
        break missingId;
      }

      id = R.id.grid_text;
      TextView gridText = rootView.findViewById(id);
      if (gridText == null) {
        break missingId;
      }

      return new GridItemBinding((LinearLayout) rootView, gridImage, gridText);
    }
